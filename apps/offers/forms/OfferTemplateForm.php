...
class OfferTemplateForm extends BaseForm
{
    ...
    public function initialize()
    {
        ...
        $warning_text = new Check("template_options[warning_text]", array("value" => 1, 'id' => 'template_options[warning_text]'));
        $warning_text->setLabel("Warning Text");

        $header = new Check("template_options[header]", array("value" => 1, 'id' => 'template_options[header]'));
